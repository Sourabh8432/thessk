export const services = [
  { title: 'Web Development', color: '#00b8ff', nodes: 6 },
  { title: 'App Development', color: '#ff007f', nodes: 5 },
  { title: 'Digital Marketing', color: '#ff4d4d', nodes: 4 },
  { title: 'UI/UX Design', color: '#ffaa00', nodes: 3 },
];
